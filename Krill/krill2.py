...
a=float(input("Enter value for a (e.g. 0.2): "))
b=float(input("Enter value for b (e.g. 0.0001): "))
m=float(input("Enter value for m (e.g. 0.5): "))
n=float(input("Enter value for n (e.g. 0.000001): "))

r=float(input("Enter value for r (e.g. 0.1): "))
...
for i in range(nSteps):
	...
	oldKrill = krill
	krill = krill +  ((a-b*whale)*krill - r*krill)    * deltaT
